...
1. Hardware inspection and testing
2. Secure data wipe (NIST/DOD standards)
3. Component cleaning and minor repairs
4. ChromeOS Flex installation
...
1. **Students** (K-12, college) - homework, research, skill-building
2. **Families** - home access to education, healthcare, government services
3. **Veterans** - job search, benefits access, connection to resources
4. **Job Seekers** - resume building, applications, skills training
5. **Nonprofits** - technology capacity building for organizations
...
**Primary Colors**:
- **HTI Navy**: `#1e3a5f` - Primary brand color, headers, strong text
- **Accent Teal**: `#4a9b9f` and `#6db3b7` - Interactive elements, highlights
- **Alert/Youth Red**: `#ff6b6b` - Calls-to-action, urgency, youth programs
- **Kiwanis Yellow**: `#fff9c4` (light) and `#ffeb3b` (bright) - Partnership highlights
...
- **File**: `hti-mobile-mini-site.html`
